# 2024-08-01 — original design notes & revision history (preserved)

This is the original orbital-puppet README, kept verbatim as the projects first devlog
entry when the README was slimmed down (on 2026-06-25). It captures the original design
rationale, the orbital-sys framing, and the Rev 1-4 thinking (text -> voice out -> voice
in -> animated face) plus the big reference list of lip-sync / TTS / STT resources.
